...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { description: @artwork.description, img: @artwork.img, price: @artwork.price, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { description: @artwork.description, img: @artwork.img, price: @artwork.price, title: @artwork.title } }
